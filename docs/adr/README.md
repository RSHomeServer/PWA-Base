...
Accepted decisions for the Website_Hosting platform:

| ADR                                       | Title                                            |
| ----------------------------------------- | ------------------------------------------------ |
| [001](./001-modular-monolith-host.md)     | Modular monolith with Vite/React/TypeScript host |
| [002](./002-site-registration-catalog.md) | Path-based site registration and catalog         |
